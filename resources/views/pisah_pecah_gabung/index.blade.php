    ...
    <section class="job-form-section pt_120 pb_120 mb-5">
        <div class="auto-container">
            <div class="sec-title centred pb_70 light sec-title-animation animation-style2">
                ...
                <h2 class="title-animation">Permohonan Pemisahan Pemecahan Penggabungan Sertipikat</h2>
                    ...
                    <div class="col-12 form-column">
                        <div class="form-inner">
                            ...
                            <div class="row clearfix justify-content-center">
                                ...
                                <div class="col-md-3 col-6 form-group">
                                            <label for="">Nomor Kohir</label>
                                            <input type="text" name="kohir">
                                        </div>
                                        <div class="col-md-3 col-6 form-group">
                                        ...
                                        <div class="col-md-3 col-6">
                                            ...
                                            <select name="rencana_penggunaan_tanah" class="form-control" required>
                                                <option value="Non Pertanian">Non Pertanian</option>
                                                <option value="Pertanian">Pertanian</option>
                                            </select>
                                        </div>
            ...
            $(document).on('submit', '#form_permohonan', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        window.location.href = "{{ route('viewPisahPecahGabung') }}?id=" +
