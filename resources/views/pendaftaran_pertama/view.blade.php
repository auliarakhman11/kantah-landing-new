    ...
    <section class="service-section centred pt_110 pb_90">
        <div class="auto-container">
            <div class="sec-title pb_60 sec-title-animation animation-style2">
                ...
                <h2 class="title-animation">Formulir Pendaftaran Sertipikat Tahap 1 berhasil dibuat!</h2>
            </div>
                        ...
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a
                                        href="{{ route('downloadPendaftaranPertama', ['id' => $id, 'device_id' => $device_id]) }}"><img
                            ...
                            <div class="lower-content">
                                <h3><a
                                        href="{{ route('downloadPendaftaranPertama', ['id' => $id, 'device_id' => $device_id]) }}">Download
                                        Formulir</a></h3>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="visible-print text-center">
                        {!! QrCode::size(300)->generate(route('downloadPendaftaranPertama', ['id' => $id, 'device_id' => $device_id])) !!}
