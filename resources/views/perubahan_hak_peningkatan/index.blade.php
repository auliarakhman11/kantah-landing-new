    ...
    <section class="job-form-section pt_120 pb_120 mb-5">
        <div class="auto-container">
            <div class="sec-title centred pb_70 light sec-title-animation animation-style2">
                ...
                <h2 class="title-animation">Perubahan Hak Peningkatan</h2>
                        ...
                        <div class="form-inner">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6 col-12 form-group">
                                    ...
                                    <select class="form-control " name="warga_negara_kuasa" required>
                                        <option value="WNI">WNI</option>
                                        <option value="WNA">WNA</option>
                                    </select>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit', '#form_permohonan', function(event) {
                ...
                $.ajax({
                    url: "{{ route('addPerubahanHakPeningkatan') }}",
                    method: 'POST',
                    ...
                    success: function(data) {
                        ...
                        window.location.href = "{{ route('viewPerubahanHakPeningkatan') }}?id=" +
