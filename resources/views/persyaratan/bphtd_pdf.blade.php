            ...
            <div class="container" data-aos="fade-up">
              ...
              <div class="row content">
                <div class="col-8" data-aos="fade-right mb-3">
                  <h3>Persyaratan Pencatatan Pelunasan BPHTB/PPH</h3>
                  @if ($active->aktif)
                ...
                <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left">
                  ...
                  <ul>
                    ...
                    <li><i class="ri-check-double-line"></i> BPHTB Asli</li>
                    <li><i class="ri-check-double-line"></i> FC SPPT PBB Tahun Bejalan</li>
