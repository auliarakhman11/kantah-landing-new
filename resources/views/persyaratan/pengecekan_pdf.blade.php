            ...
            <div class="container" data-aos="fade-up">
              ...
              <div class="row content">
                <div class="col-8" data-aos="fade-right mb-3">
                  <h3>Persyaratan Pengecekan Sertipikat</h3>                  
                  <h5 class="text-warning">Biaya : Rp. 50.000</h5>
                  <h5 class="text-success">Estimasi Waktu 1 Hari Kerja*</h5>
                  @if ($active->aktif)
                  <h6 class="text-success">Estimasi Waktu 1 Hari Kerja</h6>
                  @endif
                </div>               
                ...
                <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left">
                  ...
                  <ul>
                    ...
                    <li><i class="ri-check-double-line"></i> Permohonan</li>
                    <li><i class="ri-check-double-line"></i> Surat Pernyataan Keabsahan Dokumen</li>
                    <li><i class="ri-check-double-line"></i> Fotokopi KTP & KK Yang Bersangkutan</li>
                    <li><i class="ri-check-double-line"></i> Apabila An. Badan Hukum/Yasasan Lampirkan: 
                        <br>- Fotokopi KTP dan KK Direktur / Pimpinan
                        <br>- Fotokopi Akta Pendirian / Salinan Perubahan
                        <br>- Fotokopi Pengesahan Badan Hukum
                    </li>
