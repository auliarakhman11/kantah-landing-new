                    ...
                    <div class="content_block_one">
                        <div class="content-box mr_80">
                            <div class="sec-title pb_20 sec-title-animation animation-style2">
                                <h2 class="title-animation">Persyaratan Pengecekan Sertipikat</h2>
                            </div>
        ...
        <span class="sub-title mb_10 title-animation">Peralihan Hak - Jual Beli</span>
            ...
            specialized skills in areas such as hospitality management.</p> --}}
                                <ul class="list-style-one clearfix">
                                    ...
                                    <li>Fotokopi KTP & KK Yang Bersangkutan</li>
                                    <li>
                                        Apabila An. Badan Hukum/Yasasan Lampirkan:
                                        <ul>
                                            <li>Fotokopi KTP dan KK Direktur / Pimpinan</li>
                                            <li>Fotokopi Akta Pendirian / Salinan Perubahan</li>
                                            <li>Fotokopi Pengesahan Badan Hukum</li>
                                        </ul>
                                    </li>
                                    <li>Surat Kuasa Bermatrai Asli (Jika Dikuasakan)</li>
