    ...
    <section class="job-form-section pt_120 pb_120 mb-5">
        <div class="auto-container">
            <div class="sec-title centred pb_70 light sec-title-animation animation-style2">
                ...
                <h2 class="title-animation">Perubahan Hak Penurunan</h2>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 form-column">
                        <div class="form-inner">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6 col-6 form-group">
                                    <label for="">Tempat Tanggal Lahir</label>
                                    <input type="text" name="ttl_kuasa">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                ...
                                <div class="col-md-6 col-12 form-group">
                                    ...
                                    <select class="form-control " name="warga_negara_kuasa">
                                        <option value="WNI">WNI</option>
                                        <option value="WNA">WNA</option>
                                    </select>
                                </div>
                        ...
                        <div class="form-inner">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6 col-6 form-group">
                                    ...
                                    <input type="date" name="tgl_hak" class="form-control" required>
                                </div>
                                <div class="col-md-6 col-6 form-group">
                                    <label for="">Tahun SPPT-PBB</label>
                                    <input type="number" name="tahun_sppt" class="form-control" required>
                                </div>
                                ...
                                <div class="col-md-6 col-6 form-group">
                                    ...
                                    <input type="text" name="nomor_su" class="form-control" required>
                                </div>

                                <div class="col-md-6 col-6 form-group">
                                    <label for="">Tanggal Surat ukur</label>
                                    <input type="date" name="tgl_su" class="form-control" required>
                                </div>
                                <div class="col-md-6 col-6 form-group">
                                ...
                                <div class="col-md-6 col-6 form-group">
                                    <label for="">Nomor Identifikasi Bidang ( NIB )</label>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit', '#form_permohonan', function(event) {
                ...
                $.ajax({
                    url: "{{ route('addPerubahanHakPenurunan') }}",
                    method: 'POST',
                    ...
                    success: function(data) {
                        ...
                        window.location.href = "{{ route('viewPerubahanHakPenurunan') }}?id=" +
