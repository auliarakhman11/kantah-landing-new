                    ...
                    <div class="col-12 col-md-6 mt-2">
                        <div class="form-group">
                            ...
                            <select name="jenis" class="form-control" required>
                                ...
                                <option value="Peralihan Hak Jual Beli">Permohonan Peralihan Hak Jual Beli</option>
                                <option value="Peralihan Hak Hibah">Permohonan Peralihan Hak Hibah</option>
                                <option value="Peralihan Hak Waris">Permohonan Peralihan Hak Waris</option>
                                <option value="Peralihan Hak Lelang">Permohonan Peralihan Hak Lelang</option>
                                <option value="Peralihan Hak Tukar Menukar">Permohonan Peralihan Hak Tukar Menukar</option>
                                <option value="Peralihan Hak Pembagian Hak Bersama">Permohonan Peralihan Hak Pembagian Hak Bersama</option>
                            </select>
                        </div>
                    </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            Swal.fire({
                                ...
                                window.location.href = "redirect-peralihan-hak/"+data.peralihan_hak_id;                        
                        },
