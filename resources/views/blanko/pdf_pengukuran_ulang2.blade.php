                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 221.65pt;padding: 0cm;height: 29.65pt;vertical-align: top;">
                                    ...
                                    <p style='margin-top:1.85pt;margin-right:0cm;margin-bottom:0cm;margin-left:4.75pt;font-size:15px;font-family:"Cambria",serif;'>({{ $pengukuran_ulang->utara }}) <br></p>
                                </td>
                            ...
                            <tr>
                                <td style="width: 221.65pt;padding: 0cm;height: 29.65pt;vertical-align: top;">
                                    <p style='margin-top:.9pt;margin-right:0cm;margin-bottom:0cm;margin-left:4.75pt;font-size:15px;font-family:"Cambria",serif;'>&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;..</p>
                                    <p style='margin-top:2.0pt;margin-right:0cm;margin-bottom:0cm;margin-left:4.75pt;font-size:15px;font-family:"Cambria",serif;'>({{ $pengukuran_ulang->timur }}) <br></p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="width: 221.65pt;padding: 0cm;height: 29.75pt;vertical-align: top;">
                                    <p style='margin-top:.9pt;margin-right:0cm;margin-bottom:0cm;margin-left:4.75pt;font-size:15px;font-family:"Cambria",serif;'>&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;..</p>
                                    <p style='margin-top:2.0pt;margin-right:0cm;margin-bottom:0cm;margin-left:4.75pt;font-size:15px;font-family:"Cambria",serif;'>({{ $pengukuran_ulang->selatan }}) <br></p>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 221.65pt;padding: 0cm;height: 14.8pt;vertical-align: top;">
                            ...
                            <tr>
                                <td style="width: 221.65pt;padding: 0cm;height: 37.1pt;vertical-align: top;">
                                    ...
                                    <p style='margin-top:1.95pt;margin-right:0cm;margin-bottom:0cm;margin-left:4.75pt;font-size:15px;font-family:"Cambria",serif;'>({{ $pengukuran_ulang->barat }}) <br></p>
                                </td>
