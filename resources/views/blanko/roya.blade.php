    ...
    <section id="features" class="features mt-5">
        <div class="container" data-aos="fade-up">
          ...
          <div class="section-title">
            <h4>Blanko Permohonan Roya, SKPT, Pencatatan, Pengecekan, IPPT</h4>
        ...
        <div class="container-fluid" data-aos="fade-up">
            <form id="post_permohonan">
                <div class="row">
                    ...
                    <div class="col-12">
                        <p>Dalam hal ini bertindak untuk dan atas nama diri sendiri / serta selaku kuasa dari :</p>
                    </div>
                    ...
                    <div class="col-12 col-md-3 mt-2">
                        <div class="form-group">
                            <label for="">Umur</label>
                            <input type="text" class="form-control" name="umur_kuasa" id="umur_kuasa" >
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-3 mt-2">
                        <div class="form-group">
                            <label for="">Pekerjaan</label>
                            <input type="text" class="form-control" name="pekerjaan_kuasa" id="pekerjaan_kuasa" >
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-3 mt-2">
                        <div class="form-group">
                            <label for="">No KTP</label>
                            <input type="text" class="form-control" name="nik_kuasa" id="nik_kuasa" >
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 mt-2">
                        <div class="form-group">
                            <label for="">Alamat</label>
                            <input type="text" class="form-control" name="alamat_kuasa" id="alamat_kuasa" >
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-3 mt-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="no_surat_kuasa" id="no_surat_kuasa" >
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-3 mt-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tgl_surat_kuasa" id="tgl_surat_kuasa" >
                        </div>
                    </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            Swal.fire({
                                ...
                                window.location.href = "redirect-roya/"+data.permohonan_id;                        
                        },
