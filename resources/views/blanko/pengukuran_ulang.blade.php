    ...
    <section id="features" class="features mt-5">
        <div class="container" data-aos="fade-up">
          ...
          <div class="section-title">
            <h4>Blanko Permohonan Pengukuran Ulang</h4>
            ...
            <form id="post_permohonan">
                <div class="row">
                    ...
                    <div class="col-12 mt-2">
                        <p>Dengan ini mengajukan permohonan pengkuran ulang terhadap sebidang tanah yang terletak di:</p>
                    </div>
                    ...
                    <div class="col-12 col-md-3 mt-2">
                        <div class="form-group">
                            <label for="">Nomor Persil</label>
                            <input type="text" class="form-control" name="no_persil" id="no_persil" >
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-3 mt-2">
                        <div class="form-group">
                            <label for="">Sebalah Utara</label>
                            <input type="text" class="form-control" name="utara" id="utara" >
                        </div>
                    </div>

                    <div class="col-12 col-md-3 mt-2">
                        <div class="form-group">
                            <label for="">Sebalah timur</label>
                            <input type="text" class="form-control" name="timur" id="timur" >
                        </div>
                    </div>

                    <div class="col-12 col-md-3 mt-2">
                        <div class="form-group">
                            <label for="">Sebalah Selatan</label>
                            <input type="text" class="form-control" name="selatan" id="selatan" >
                        </div>
                    </div>

                    <div class="col-12 col-md-3 mt-2">
                        <div class="form-group">
                            <label for="">Sebalah Barat</label>
                            <input type="text" class="form-control" name="barat" id="barat" >
                        </div>
                    </div>
      ...
      $(document).ready(function() {
        ...
        $(document).on('submit', '#post_permohonan', function(event) {
                event.preventDefault();
                    ...
                    $.ajax({
                        url:"{{ route('inputPengukuranUlang') }}",
                        method: 'POST',
                        ...
                        success: function(data) {
                            ...
                            Swal.fire({
                                ...
                                window.location.href = "redirect-pengukuran-ulang/"+data.permohonan_id;                        
                        },
