    ...
    <section id="features" class="features mt-5">
        <div class="container" data-aos="fade-up">
          ...
          <div class="section-title">
            <h2>Blanko Permohonan Sertifikat Pertamakali</h2>
            ...
            <a href="{{ route('pdfPertamakali',$id) }}" class="btn btn-success float-right"><i class="ri-file-download-line"></i> Download</a>
        ...
        <div class="container-fluid" data-aos="fade-up">
            ...
            <div class="scroll row justify-content-center">
                <div class="col-12 col-md-8">
                        ...
                        <tbody>
                            <tr>
                                <td style="width: 353.8pt;padding: 0cm 5.4pt;height: 85.55pt;vertical-align: top;">
                                    <p style='margin-top:12.0pt;margin-right:0cm;margin-bottom:  0cm;margin-left:0cm;line-height:108%;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'><span style='font-family:"Times New Roman",serif;'>Perihal: Permohonan Pengukuran></p>
                                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:0cm;margin-left:0cm;line-height:108%;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;text-indent:  38.5pt;'><span style='font-family:"Times New Roman",serif;'>Untuk Mendapatkan</span></p>
                                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:0cm;margin-left:33.0pt;line-height:108%;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;text-indent:5.5pt;'><span style='font-family:"Times New Roman",serif;'><u>Peta Bidang Tanah</u></span></p>
                                </td>
                    ...
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:324.0pt;line-height:107%;font-size:15px;font-family:"Calibri",sans-serif;text-indent:-311.5pt;'><span style='font-family:"Times New Roman",serif;'>Nama&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: {{ $pertamakali->nama }}</span></p>
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:324.0pt;line-height:107%;font-size:15px;font-family:"Calibri",sans-serif;text-indent:-311.5pt;'><span style='font-family:"Times New Roman",serif;'>Pekerjaan&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: {{ $pertamakali->pekerjaan }}</span></p>
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:324.0pt;line-height:107%;font-size:15px;font-family:"Calibri",sans-serif;text-indent:-311.5pt;'><span style='font-family:"Times New Roman",serif;'>Alamat&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: {{ $pertamakali->alamat }}</span></p>
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:324.0pt;line-height:107%;font-size:15px;font-family:"Calibri",sans-serif;text-indent:-311.5pt;'><span style='font-family:"Times New Roman",serif;'>Untuk dan atas nama&nbsp; &nbsp; &nbsp; &nbsp;: {{ $pertamakali->nm_kuasa }}</span></p>
                    <p style='margin-top:12.0pt;margin-right:0cm;margin-bottom:8.0pt;margin-left:14.2pt;line-height:150%;font-size:15px;font-family:"Calibri",sans-serif;text-align:justify;'><span style='font-family:"Times New Roman",serif;'>Dengan ini mengajukan permohonan untuk mendapatkan pelayanan dan penyelesaian sebagaimana perihal tersebut diatas, terhadap sebidang tanah yang terletak di jalan {{ $pertamakali->jalan_tanah }}. &nbsp;RT. {{ $pertamakali->rt }}. RW. {{ $pertamakali->rw }}. Kelurahan {{ $pertamakali->kelurahan->nm_kelurahan }} Kecamatan {{ $pertamakali->kecamatan->nm_kecamatan }}. Kabupaten Banjar.</span></p>
                    <p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:14.2pt;line-height:150%;font-size:15px;font-family:"Calibri",sans-serif;'><span style='font-family:"Times New Roman",serif;'>Tanah tersebut dipergunakan untuk: 
                        @if ($pertamakali->jenis_tanah == 'Non pertanian')
                    ...
                    <ol style="list-style-type: decimal;margin-left:20.5px;">
                        ...
                        <li><span style='font-family:"Times New Roman",serif;'>Asli Alas Hak (Segel/Surat Keterangan Tanah/AJB & lainnya);</span></li>
                        <li><span style='font-family:"Times New Roman",serif;'>Photo copy SPPT PBB tahun benjalan</span></li>
                        <li><span style='font-family:"Times New Roman",serif;'>Kwitansi Pendaftaran;</span></li>
                        <li><span style='font-family:"Times New Roman",serif;'>Blanko Pernyataan Pemasangan Tanda Batas;</span></li>
                        <li><span style='font-family:"Times New Roman",serif;'>Blanko Pertelaan Tanah;</span></li>
                        <li><span style='font-family:"Times New Roman",serif;'>Blanko Pengumuman Data Fisik & Yuridis</span></li>
                        <li><span style='font-family:"Times New Roman",serif;'>Blanko Risalah Penelitian Data Yuridis dan Penetapan Batas</span></li>
                    </ol>
            ...
            <div class="scroll row justify-content-center">
                <div class="col-12 col-md-8">
                    ...
                    <p style='margin-top:.05pt;margin-right:0cm;margin-bottom:.0001pt;margin-left:11.3pt;font-size:15px;font-family:"Cambria",serif;'>Nama&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: {{ $pertamakali->nama }}</p>
                    <p style='margin-top:1.95pt;margin-right:0cm;margin-bottom:.0001pt;margin-left:11.3pt;font-size:15px;font-family:"Cambria",serif;'>Umur&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: {{ $pertamakali->umur }}</p>
                    <p style='margin-top:2.0pt;margin-right:0cm;margin-bottom:0cm;margin-left:11.3pt;font-size:15px;font-family:"Cambria",serif;'>NIK&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: {{ $pertamakali->nik }}</p>
                    <p style='margin-top:2.0pt;margin-right:0cm;margin-bottom:0cm;margin-left:11.3pt;font-size:15px;font-family:"Cambria",serif;'>Pekerjaan&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;: {{ $pertamakali->pekerjaan }}</p>
                    <p style='margin-top:1.85pt;margin-right:0cm;margin-bottom:.0001pt;margin-left:11.3pt;font-size:15px;font-family:"Cambria",serif;'>Alamat&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; : {{ $pertamakali->alamat }}</p>

                    <p style='margin-top:.3pt;margin-right:0cm;margin-bottom:0cm;margin-left:0cm;font-size:15px;font-family:"Cambria",serif;'><span style="font-size:19px;">&nbsp;</span></p>
                    <p style='margin-top:2.0pt;margin-right:0cm;margin-bottom:0cm;margin-left:11.3pt;font-size:15px;font-family:"Cambria",serif;'>Adalah&nbsp;pemilik&nbsp;tanah&nbsp;Kohir&nbsp;No. {{ $pertamakali->no_hak }} Persil {{ $pertamakali->no_persil ? $pertamakali->no_persil : '..............................' }} Kelas {{ $pertamakali->kelas ? $pertamakali->kelas : '..............................' }} seluas&plusmn; {{ $pertamakali->luas }} m<sup style="font-size: 9px;">2</sup> yang&nbsp;terletak&nbsp;di {{ $pertamakali->jalan_tanah }} Desa/Kelurahan {{ $pertamakali->kelurahan->nm_kelurahan }} Kecamatan {{ $pertamakali->kecamatan->nm_kecamatan }} Kabupaten Banjar berdasarkan&nbsp;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;......................................</p>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 221.65pt;padding: 0cm;height: 29.65pt;vertical-align: top;">
                                    ...
                                    <p style='margin-top:1.85pt;margin-right:0cm;margin-bottom:0cm;margin-left:4.75pt;font-size:15px;font-family:"Cambria",serif;'>({{ $pertamakali->utara }})</p>
                                </td>
                                <td rowspan="5" style="width: 204.7pt;padding: 0cm;height: 29.65pt;vertical-align: top;">
                                    ...
                                    <p style='margin-top:0cm;margin-right:18.95pt;margin-bottom:.0001pt;margin-left:20pt;font-size:15px;font-family:"Cambria",serif;text-align:center;'>{{ $pertamakali->nama_kuasa ?  $pertamakali->nama_kuasa : $pertamakali->nama}}</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="width: 221.65pt;padding: 0cm;height: 29.65pt;vertical-align: top;">
                                    <p style='margin-top:.9pt;margin-right:0cm;margin-bottom:0cm;margin-left:4.75pt;font-size:15px;font-family:"Cambria",serif;'>&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;..</p>
                                    <p style='margin-top:2.0pt;margin-right:0cm;margin-bottom:0cm;margin-left:4.75pt;font-size:15px;font-family:"Cambria",serif;'>({{ $pertamakali->timur }})</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="width: 221.65pt;padding: 0cm;height: 29.75pt;vertical-align: top;">
                                    <p style='margin-top:.9pt;margin-right:0cm;margin-bottom:0cm;margin-left:4.75pt;font-size:15px;font-family:"Cambria",serif;'>&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;..</p>
                                    <p style='margin-top:2.0pt;margin-right:0cm;margin-bottom:0cm;margin-left:4.75pt;font-size:15px;font-family:"Cambria",serif;'>({{ $pertamakali->selatan }})</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 221.65pt;padding: 0cm;height: 14.8pt;vertical-align: top;">
                            ...
                            <tr>
                                <td style="width: 221.65pt;padding: 0cm;height: 37.1pt;vertical-align: top;">
                                    ...
                                    <p style='margin-top:1.95pt;margin-right:0cm;margin-bottom:0cm;margin-left:4.75pt;font-size:15px;font-family:"Cambria",serif;'>({{ $pertamakali->barat }})</p>
                                </td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="visible-print text-center">
                {!! QrCode::size(300)->generate(route('pdfPertamakali',$id)); !!}
                <p><strong>No Tiket: {{ $pertamakali->permohonan->no_tiket }}</strong></p>
            </div>
        </div>
