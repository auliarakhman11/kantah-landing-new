            ...
            <form id="post_permohonan">
                <div class="row">
                    ...
                    <div class="col-12 mt-2">
                        <p>Dengan ini mengajukan permohonan terhadap sebidang tanah yang terletak di:</p>
                    </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            Swal.fire({
                                ...
                                window.location.href = "redirect-pertamakali/"+data.permohonan_id;                        
                        },
