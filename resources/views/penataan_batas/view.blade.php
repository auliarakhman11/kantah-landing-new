    ...
    <section class="service-section centred pt_110 pb_90">
        <div class="auto-container">
            <div class="sec-title pb_60 sec-title-animation animation-style2">
                ...
                <h2 class="title-animation">Formulir Penataan Batas berhasil dibuat!</h2>
            </div>
                        ...
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a
                                        href="{{ route('downloadPenataanBatas', ['id' => $id, 'device_id' => $device_id]) }}"><img
                            ...
                            <div class="lower-content">
                                <h3><a
                                        href="{{ route('downloadPenataanBatas', ['id' => $id, 'device_id' => $device_id]) }}">Download
                                        Formulir</a></h3>
                                <p>Fitur download formulir dengan format dokumen agar mudah diakses dan dimodifikasi.</p>
                                <div class="btn-box"><a
                                        href="{{ route('downloadPenataanBatas', ['id' => $id, 'device_id' => $device_id]) }}"
                                        class="theme-btn btn-one">
                                        Download</a></div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="visible-print text-center">
                        {!! QrCode::size(300)->generate(route('downloadPenataanBatas', ['id' => $id, 'device_id' => $device_id])) !!}
